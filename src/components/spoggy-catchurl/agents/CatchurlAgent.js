...
* @extend eve.Agent
*/
export function CatchurlAgent(id, app) {
...
CatchurlAgent.prototype = Object.create(eve.Agent.prototype);
CatchurlAgent.prototype.constructor = CatchurlAgent;

/**
* Send a greeting to an agent
* @param {String} to
*/
CatchurlAgent.prototype.sayHello = function(to) {
  this.send(to, 'Hello ' + to + '!');
};

/**
* Handle incoming greetings. This overloads the default receive,
* so we can't use CatchurlAgent.on(pattern, listener) anymore
* @param {String} from     Id of the sender
* @param {*} message       Received message, a JSON object (often a string)
*/
CatchurlAgent.prototype.receive = function(from, message) {
